...
void make_page_readonly(const void *va, unsigned int feature)
{
	if (!xen_feature(feature))
		__make_page_readonly((unsigned long)va);
}

void make_page_writable(const void *va, unsigned int feature)
{
	if (!xen_feature(feature))
		__make_page_writable((unsigned long)va);
}

void make_pages_readonly(const void *va, unsigned int nr, unsigned int feature)
{
	unsigned long addr;
...
void make_pages_writable(const void *va, unsigned int nr, unsigned int feature)
{
	unsigned long addr;
